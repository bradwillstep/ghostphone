...
<body>
  <h1>ULTRA LISTENER // WORKER TEXT-ONLY (BUILD v6-reset-1767895876-sxmmba)</h1>
  ...
  <script>
    ...
    async function appReset(){
      ...
      showOverlay("Reset complete", "Service workers and caches cleared. Close this tab and reopen your site with ?fresh=1.", null);
    }
